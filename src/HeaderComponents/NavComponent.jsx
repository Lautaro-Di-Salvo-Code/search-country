  ...
  return (
    ...
    <section className=' dark:bg-background-darksoft bg-background-lighthard    h-[10vh] px-[.5rem]  md:px-[4rem]'>
        ...
        max-w-1400pxMaxW
          ...
          h-[10vh]'>
            <b className='m-[1rem] md:hover:scale-110 ease-out duration-300 cursor-pointer dark:text-[#fff] text-[#000] text-[1rem] md:text-[2rem]'>Where in the world?</b>
        <figure className='m-[1rem] figure__darkmode md:hover:scale-110 ease-out duration-300 cursor-pointer'>
